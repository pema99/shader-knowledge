...
**Important:** This page is kept for historical reasons. VRChat now has [a built-in API for reading data from a shader back to Udon](https://creators.vrchat.com/worlds/udon/vrc-graphics/asyncgpureadback/). 
